...
#define nrn_init _nrn_init__ISK
#define _nrn_initial _nrn_initial__ISK
#define nrn_cur _nrn_cur__ISK
#define _nrn_current _nrn_current__ISK
#define nrn_jacob _nrn_jacob__ISK
#define nrn_state _nrn_state__ISK
#define _net_receive _net_receive__ISK 
#define rates rates__ISK 
#define states states__ISK 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ISK", _hoc_setdata,
 "rates_ISK", _hoc_rates,
 0, 0
};
...
#define _gth 0
#define tau_z_ISK _thread1data[0]
#define tau_z _thread[_gth]._pval[0]
#define z_inf_ISK _thread1data[1]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ISK /Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/ISK.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/ISK.mod";
static const char* nmodl_file_text = 
