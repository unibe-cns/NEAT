...
#define nrn_init _nrn_init__OUClamp2
#define _nrn_initial _nrn_initial__OUClamp2
#define nrn_cur _nrn_cur__OUClamp2
#define _nrn_current _nrn_current__OUClamp2
#define nrn_jacob _nrn_jacob__OUClamp2
#define nrn_state _nrn_state__OUClamp2
#define _net_receive _net_receive__OUClamp2 
#define noiseFromRandom noiseFromRandom__OUClamp2 
#define seed seed__OUClamp2 
...
#define per _p[8]
#define per_columnindex 8
#define ival _p[9]
#define ival_columnindex 9
#define ivar _p[10]
#define ivar_columnindex 10
#define flag1 _p[11]
#define flag1_columnindex 11
#define exp_decay _p[12]
#define exp_decay_columnindex 12
#define amp_gauss _p[13]
#define amp_gauss_columnindex 13
#define v _p[14]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 OUClamp2 /Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/OUClamp2.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   if ( t < delay ) {
     ...
     if ( t < delay + dur ) {
       ivar = mean + exp_decay * ( ivar - mean ) + stdev * amp_gauss * ival ;
       }
     else {
       ivar = 0. ;
       }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/OUClamp2.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
