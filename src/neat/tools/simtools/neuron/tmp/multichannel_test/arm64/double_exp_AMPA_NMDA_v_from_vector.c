...
#define nrn_init _nrn_init__double_exp_AMPA_NMDA_v_from_vector
#define _nrn_initial _nrn_initial__double_exp_AMPA_NMDA_v_from_vector
#define nrn_cur _nrn_cur__double_exp_AMPA_NMDA_v_from_vector
#define _nrn_current _nrn_current__double_exp_AMPA_NMDA_v_from_vector
#define nrn_jacob _nrn_jacob__double_exp_AMPA_NMDA_v_from_vector
#define nrn_state _nrn_state__double_exp_AMPA_NMDA_v_from_vector
#define _net_receive _net_receive__double_exp_AMPA_NMDA_v_from_vector 
#define _f_mgblock _f_mgblock__double_exp_AMPA_NMDA_v_from_vector 
#define betadyn betadyn__double_exp_AMPA_NMDA_v_from_vector 
#define mgblock mgblock__double_exp_AMPA_NMDA_v_from_vector 
...
#define z_r _p[7]
#define z_r_columnindex 7
#define v_fv _p[8]
#define v_fv_columnindex 8
#define i _p[9]
...
#define usetable usetable_double_exp_AMPA_NMDA_v_from_vector
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_double_exp_AMPA_NMDA_v_from_vector", 0, 1,
 0,0,0
};
 ...
 "usetable_double_exp_AMPA_NMDA_v_from_vector", &usetable_double_exp_AMPA_NMDA_v_from_vector,
 0,0
};
...
#define _cvode_ieq _ppvar[2]._i
 ...
 "7.7.0",
"double_exp_AMPA_NMDA_v_from_vector",
 "tau1",
 "tau2",
 "tau1_NMDA",
 "tau2_NMDA",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _double_exp_AMPA_NMDA_v_from_vector_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 double_exp_AMPA_NMDA_v_from_vector /Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/double_exp_AMPA_NMDA_v_from_vector.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   mgblock ( _threadargscomma_ v_fv ) ;
   g_tot = ( A_AMPA + B_AMPA ) + f_NMDA * ( A_NMDA + B_NMDA ) ;
   i = g_tot / ( 1. + z_r * g_tot ) * ( v - e ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/double_exp_AMPA_NMDA_v_from_vector.mod";
static const char* nmodl_file_text = 
  "TITLE   double Exp NMDA synapse\n"
  "\n"
  "NEURON {\n"
  "    POINT_PROCESS double_exp_AMPA_NMDA_v_from_vector\n"
  "    RANGE tau1, tau2, tau1_NMDA, tau2_NMDA, mg, i, e, z_r, v_fv, NMDA_ratio\n"
