...
#define nrn_init _nrn_init__OUReversal
#define _nrn_initial _nrn_initial__OUReversal
#define nrn_cur _nrn_cur__OUReversal
#define _nrn_current _nrn_current__OUReversal
#define nrn_jacob _nrn_jacob__OUReversal
#define nrn_state _nrn_state__OUReversal
#define _net_receive _net_receive__OUReversal 
#define oup oup__OUReversal 
#define seed seed__OUReversal 
...
#define gvar _p[11]
#define gvar_columnindex 11
#define evar _p[12]
#define evar_columnindex 12
#define flag1 _p[13]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 OUReversal /Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/OUReversal.mod\n");
...
static int  oup (  ) {
   if ( t < delay ) {
     ...
     if ( t < delay + dur ) {
       evar = mean + exp_decay * ( evar - mean ) + amp_gauss * normrand ( 0.0 , 1.0 ) ;
       }
     else {
       gvar = 0. ;
       evar = mean ;
...
static int _ode_count(int _type){ hoc_execerror("OUReversal", "cannot be used with CVODE"); return 0;}
...
{
 { error =  oup();
 if(error){fprintf(stderr,"at line 78 in file OUReversal.mod:\n    SOLVE oup\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/wybo/Code/NEAT_public/neat/tools/simtools/neuron/tmp/multichannel_test/mech/OUReversal.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
