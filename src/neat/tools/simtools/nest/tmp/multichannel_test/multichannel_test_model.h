...
CompartmentMultichannelTestModel voltages can be recorded. To do so, create a multimeter in the
...
class multichannel_test_model : public ArchivingNode
{

public:
  multichannel_test_model();
  multichannel_test_model( const multichannel_test_model& );
...
private:
  ...
  CompTreeMultichannelTestModel c_tree_;
  ...
  friend class DataAccessFunctor< multichannel_test_model >;
  friend class DynamicRecordablesMap< multichannel_test_model >;
  friend class DynamicUniversalDataLogger< multichannel_test_model >;
  ...
  */
  ...
  DynamicRecordablesMap< multichannel_test_model > recordablesMap_;
  //! Logger for all analog data
  DynamicUniversalDataLogger< multichannel_test_model > logger_;
...
inline size_t
nest::multichannel_test_model::send_test_event( Node& target, size_t receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline size_t
multichannel_test_model::handles_test_event( SpikeEvent&, size_t receptor_type )
{
...
inline size_t
multichannel_test_model::handles_test_event( CurrentEvent&, size_t receptor_type )
{
...
inline size_t
multichannel_test_model::handles_test_event( DataLoggingRequest& dlr, size_t receptor_type )
{
  if ( receptor_type != 0 )
  {
