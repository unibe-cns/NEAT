...
double TestChannel::DfDvNewton(double v){
    ...
    double a00 = 1.0/(0.74081822068171788*exp(0.01*v_a00) + 1.0);
    return -1. * (5*pow(a00, 3)*pow(a01, 3)*a02 + pow(a10, 2)*pow(a11, 2)*a12 - m_p_open_eq) + (15*pow(a00, 3)*pow(a01, 2)*a02 * da01_dv + 5*pow(a00, 3)*pow(a01, 3) * da02_dv + pow(a10, 2)*pow(a11, 2) * da12_dv + 2*pow(a10, 2)*a11*a12 * da11_dv + 2*a10*pow(a11, 2)*a12 * da10_dv + 15*pow(a00, 2)*pow(a01, 3)*a02 * da00_dv) * (m_e_rev - v);
}
...
double TestChannel2::DfDvNewton(double v){
    ...
    double a01 = 0.5;
    return -1. * (0.90000000000000002*pow(a00, 3)*pow(a01, 2) + 0.10000000000000001*pow(a10, 2)*a11 - m_p_open_eq) + (0.10000000000000001*pow(a10, 2) * da11_dv + 0.20000000000000001*a10*a11 * da10_dv + 2.7000000000000002*pow(a00, 2)*pow(a01, 2) * da00_dv + 1.8*pow(a00, 3)*a01 * da01_dv) * (m_e_rev - v);
}
...
double Na_Ta::fNewton(double v){
    ...
    double m = 0.182*(v_m + 38.0)/((1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m))*(-0.124*(v_m + 38.0)/(1.0 - 563.03023683595109*exp(0.16666666666666666*v_m)) + 0.182*(v_m + 38.0)/(1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m))));
    double v_h;
    if(m_v_h > 1000.){
        v_h = v;
    } else{
    ...
    double h = -0.014999999999999999*(v_h + 66.0)/((1.0 - 59874.141715197817*exp(0.16666666666666666*v_h))*(-0.014999999999999999*(v_h + 66.0)/(1.0 - 59874.141715197817*exp(0.16666666666666666*v_h)) + 0.014999999999999999*(v_h + 66.0)/(1.0 - 1.6701700790245659e-5*exp(-0.16666666666666666*v_h))));
...
double Na_Ta::DfDvNewton(double v){
    ...
    if(m_v_m > 1000.){
        v_m = v;
        dm_dv = 5.4945054945054945*(v_m + 38.0)*(0.124/(1.0 - 563.03023683595109*exp(0.16666666666666666*v_m)) - 0.182/(1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m)) + 5.3875140887276158e-5*(v_m + 38.0)*exp(-0.16666666666666666*v_m)/pow(1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m), 2) + 3.6706139945177168e-5*(v_m + 38.0)*exp(0.16666666666666666*v_m)/pow(0.0017761035457343791 - exp(0.16666666666666666*v_m), 2))/((1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m))*pow(-0.68131868131868134*(v_m + 38.0)/(1.0 - 563.03023683595109*exp(0.16666666666666666*v_m)) + (v_m + 38.0)/(1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m)), 2)) + 0.182/((1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m))*(-0.124*(v_m + 38.0)/(1.0 - 563.03023683595109*exp(0.16666666666666666*v_m)) + 0.182*(v_m + 38.0)/(1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m)))) - 5.3875140887276158e-5*(v_m + 38.0)*exp(-0.16666666666666666*v_m)/(pow(1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m), 2)*(-0.124*(v_m + 38.0)/(1.0 - 563.03023683595109*exp(0.16666666666666666*v_m)) + 0.182*(v_m + 38.0)/(1.0 - 0.0017761035457343791*exp(-0.16666666666666666*v_m))));
    } else{
        v_m = m_v_m;
        dm_dv = 0;
    }
    ...
    if(m_v_h > 1000.){
        v_h = v;
        dh_dv = -66.666666666666657*(v_h + 66.0)*(0.014999999999999999/(1.0 - 59874.141715197817*exp(0.16666666666666666*v_h)) - 0.014999999999999999/(1.0 - 1.6701700790245659e-5*exp(-0.16666666666666666*v_h)) + 4.1754251975614145e-8*(v_h + 66.0)*exp(-0.16666666666666666*v_h)/pow(1.0 - 1.6701700790245659e-5*exp(-0.16666666666666666*v_h), 2) + 4.1754251975614145e-8*(v_h + 66.0)*exp(0.16666666666666666*v_h)/pow(1.6701700790245659e-5 - exp(0.16666666666666666*v_h), 2))/((1.0 - 59874.141715197817*exp(0.16666666666666666*v_h))*pow(-(v_h + 66.0)/(1.0 - 59874.141715197817*exp(0.16666666666666666*v_h)) + (v_h + 66.0)/(1.0 - 1.6701700790245659e-5*exp(-0.16666666666666666*v_h)), 2)) - 0.014999999999999999/((1.0 - 59874.141715197817*exp(0.16666666666666666*v_h))*(-0.014999999999999999*(v_h + 66.0)/(1.0 - 59874.141715197817*exp(0.16666666666666666*v_h)) + 0.014999999999999999*(v_h + 66.0)/(1.0 - 1.6701700790245659e-5*exp(-0.16666666666666666*v_h)))) - 4.1754251975614145e-8*(v_h + 66.0)*exp(0.16666666666666666*v_h)/(pow(1.6701700790245659e-5 - exp(0.16666666666666666*v_h), 2)*(-0.014999999999999999*(v_h + 66.0)/(1.0 - 59874.141715197817*exp(0.16666666666666666*v_h)) + 0.014999999999999999*(v_h + 66.0)/(1.0 - 1.6701700790245659e-5*exp(-0.16666666666666666*v_h))));
    } else{
        v_h = m_v_h;
        dh_dv = 0;
    }
...
void SK::calcFunStatevar(double v){
    m_z_inf = 1.0/(6.9286494134258575e-17*pow(1.0/m_ca, 4.7999999999999998) + 1.0);
    m_tau_z = 1.0;
}
double SK::calcPOpen(){
    return m_z;
...
double SK::fNewton(double v){
    ...
    double z = 1.0/(6.9286494134258575e-17*pow(1.0/m_ca, 4.7999999999999998) + 1.0);
...
double h::DfDvNewton(double v){
    ...
    if(m_v_hf > 1000.){
        v_hf = v;
        dhf_dv = -1.1680254746115059e-6*exp(0.14285714285714285*v_hf)/pow(exp(0.14285714285714285*v_hf) + 8.1761783222805421e-6, 2);
    } else{
        v_hf = m_v_hf;
        dhf_dv = 0;
    }
    ...
    if(m_v_hs > 1000.){
        v_hs = v;
        dhs_dv = -1.1680254746115059e-6*exp(0.14285714285714285*v_hs)/pow(exp(0.14285714285714285*v_hs) + 8.1761783222805421e-6, 2);
    } else{
        v_hs = m_v_hs;
        dhs_dv = 0;
    }
